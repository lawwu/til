---
title: "Qwen 3's Chat Prompt Template"
author: "Lawrence Wu"
date: "2025-04-25"
categories: [LLM]
---

I didn't realize how complicated Chat Templates have become now. This [Huggingface blogpost](https://huggingface.co/blog/qwen-3-chat-template-deep-dive) goes through Qwen 3's prompt template. 
...
The templates are all available on Huggingface for open source models, e.g. [Qwen3](https://huggingface.co/Qwen/Qwen3-235B-A22B?chat_template=default):

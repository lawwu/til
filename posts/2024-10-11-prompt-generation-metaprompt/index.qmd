...
author: "Lawrence Wu"
date: "2024-10-11"
categories: [prompt, llms, meta]
---

OpenAI added a system prompt generate button that lets you generate prompts, functions and schemas from just describing the task.

![OpenAI Playground New Generate Button](./openai_playground_generate.png)
...
They also say they may use more advanced techniques like DSPy and [Gradient Descent](https://arxiv.org/abs/2305.03495).

The meta prompt is quite instructive. It's awesome they've open sourced this. I've started to use LLMs to generate prompts too. They generally do a better job than I do at being comphrehensive. Of course I will then modify what the LLM generates for my specific use case and run some evaluations. Below are two meta-prompt examples and two meta-schema examples. 

## Meta-Prompt: Text-Out
